...
const SideFilterOuter = () => {
    ...
    const [isJacketSelected, setIsJacketSelected] = useState(false);
    const [isAnorakSelected, setIsAnorakSelected] = useState(false);
    const [isCoatSelected, setIsCoatSelected] = useState(false);
    const [isPaddingSelected, setIsPaddingSelected] = useState(false);
    const [isOutersSelected, setIsOutersSelected] = useState(false);
    ...
    const toggleJacket = () => {
        setIsJacketSelected(prevState => !prevState);
    };

    const toggleAnorak = () => {
        setIsAnorakSelected(prevState => !prevState);
    };

    const toggleCoat = () => {
        setIsCoatSelected(prevState => !prevState);
    };

    const togglePadding = () => {
        setIsPaddingSelected(prevState => !prevState);
    };

    const toggleOuters = () => {
        setIsOutersSelected(prevState => !prevState);
    };
    ...
    const resetFilters = () => {
        ...
        setIsJacketSelected(false);
        setIsAnorakSelected(false);
        setIsCoatSelected(false);
        setIsPaddingSelected(false);
        setIsOutersSelected(false);
...
export default SideFilterOuter;