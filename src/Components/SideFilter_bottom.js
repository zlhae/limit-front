...
const SideFilterBottom = () => {
    const [isDeliverySelected, setIsDeliverySelected] = useState(false);
    const [isDirectTradeSelected, setIsDirectTradeSelected] = useState(false);
    const [isPantsSelected, setIsPantsSelected] = useState(false);
    const [isShortPantsSelected, setIsShortPantsSelected] = useState(false);
    const [isSkirtSelected, setIsSkirtSelected] = useState(false);
    const [isLeggingsSelected, setIsLeggingsSelected] = useState(false);
    const [isBottomsSelected, setIsBottomsSelected] = useState(false);
    ...
    const togglePants = () => {
        setIsPantsSelected(prevState => !prevState);
    };

    const toggleShortPants = () => {
        setIsShortPantsSelected(prevState => !prevState);
    };

    const toggleSkirt = () => {
        setIsSkirtSelected(prevState => !prevState);
    };

    const toggleLeggings = () => {
        setIsLeggingsSelected(prevState => !prevState);
    };

    const toggleBottoms = () => {
        setIsBottomsSelected(prevState => !prevState);
    };
    ...
    const resetFilters = () => {
        ...
        setIsPantsSelected(false);
        setIsShortPantsSelected(false);
        setIsSkirtSelected(false);
        setIsLeggingsSelected(false);
        setIsBottomsSelected(false);
                            ...
                            <CateFilterBox>
                                ...
                                {isCategoryOpen && (
                                    <div className='cate_filter_checkbox'>
                                        <label><input type='checkbox' name='checkbox_pants' checked={isPantsSelected} onChange={togglePants}></input>바지</label>
                                        <label><input type='checkbox' name='checkbox_short_pants' checked={isShortPantsSelected} onChange={toggleShortPants}></input>반바지</label>
                                        <label><input type='checkbox' name='checkbox_skirt' checked={isSkirtSelected} onChange={toggleSkirt}></input>스커트</label>
                                        <label><input type='checkbox' name='checkbox_leggings' checked={isLeggingsSelected} onChange={toggleLeggings}></input>레깅스</label>
                                        <label><input type='checkbox' name='checkbox_bottoms' checked={isBottomsSelected} onChange={toggleBottoms}></input>기타 하의</label>
                                    </div>
                                )}
                            </CateFilterBox>
                            <GenderFilterBox>
...
export default SideFilterBottom;