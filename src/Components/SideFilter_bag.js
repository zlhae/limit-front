...
const SideFilterBag = () => {
    ...
    const [isPremiumbagSelected, setIsPremiumbagSelected] = useState(false);
    const [isMinibagSelected, setIsMinibagSelected] = useState(false);
    const [isBackpackSelected, setIsBackpackSelected] = useState(false);
    const [isShoulderbagSelected, setIsShoulderbagSelected] = useState(false);
    const [isTotebagSelected, setIsTotebagSelected] = useState(false);
    const [isCrossbagSelected, setIsCrossbagSelected] = useState(false);
    const [isClutchSelected, setIsClutchSelected] = useState(false);
    const [isDuffelbagSelected, setIsDuffelbagSelected] = useState(false);
    const [isEchobagSelected, setIsEchobagSelected] = useState(false);
    const [isCarrierSelected, setIsCarrierSelected] = useState(false);
    const [isBagsSelected, setIsBagsSelected] = useState(false);
    ...
    useEffect(() => {
        setShowResetButton(
            ...
            isPremiumbagSelected ||
            isMinibagSelected ||
            isBackpackSelected ||
            isShoulderbagSelected ||
            isTotebagSelected ||
            isCrossbagSelected ||
            isClutchSelected ||
            isDuffelbagSelected ||
    ...
    const togglePremiumbag = () => {
        setIsPremiumbagSelected(prevState => !prevState);
    };

    const toggleMinibag = () => {
        setIsMinibagSelected(prevState => !prevState);
    };

    const toggleBackpack = () => {
        setIsBackpackSelected(prevState => !prevState);
    };

    const toggleShoulderbag = () => {
        setIsShoulderbagSelected(prevState => !prevState);
    };

    const toggleTotebag = () => {
        setIsTotebagSelected(prevState => !prevState);
    };

    const toggleCrossbag = () => {
        setIsCrossbagSelected(prevState => !prevState);
    };

    const toggleClutch = () => {
        setIsClutchSelected(prevState => !prevState);
    };

    const toggleDuffelbag = () => {
        setIsDuffelbagSelected(prevState => !prevState);
    };

    const toggleEchobag = () => {
        setIsEchobagSelected(prevState => !prevState);
    };

    const toggleCarrier = () => {
        setIsCarrierSelected(prevState => !prevState);
    };

    const toggleBags = () => {
        setIsBagsSelected(prevState => !prevState);
    };
    ...
    const resetFilters = () => {
        ...
        setIsPremiumbagSelected(false);
        setIsMinibagSelected(false);
        setIsBackpackSelected(false);
        setIsShoulderbagSelected(false);
        setIsTotebagSelected(false);
        setIsCrossbagSelected(false);
        setIsClutchSelected(false);
        setIsDuffelbagSelected(false);
        setIsEchobagSelected(false);
        setIsCarrierSelected(false);
        setIsBagsSelected(false);
