...
const Notification=({handleShowMobileSideBar})=>{
    ...
    return(
        <ContentContainer>
            ...
            <CsCenterContent type="공지" contentData={notificationData}></CsCenterContent>
        </ContentContainer>
    );
}
